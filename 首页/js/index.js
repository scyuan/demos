	$(document).ready(function() {
		...
		function onShow(){
			...
			slowShow($(".body_camera_left"), $(".body_camera_left_text p"));
			slowShow($(".body_camera_right"), $(".body_camera_right_text p"));
		}

		function offShow(){
			cancelShow($(".model .value"), $(".value_text p"));
			cancelShow($(".model .future"), $(".future_text p"));
			cancelShow($(".body_camera_left"), $(".body_camera_left_text p"));
			cancelShow($(".body_camera_right"), $(".body_camera_right_text p"));
		}
